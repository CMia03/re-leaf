  ...
  return (
    <div className="flex justify-between items-center px-[100px] h-[124px]">
      ...
      <div className="flex gap-10">
        <Typography variant="h6" className=" cursor-pointer font-[400] text-[1.2em] hover:text-[var(--bg-primary-releaf)] transition">{t("welcome")}</Typography>
        <Typography variant="h6"  className=" cursor-pointer font-[400] text-[1.2em] hover:text-[var(--bg-primary-releaf)] transition">{t("shop")}</Typography>
        <Typography variant="h6" className=" cursor-pointer font-[400] text-[1.2em] hover:text-[var(--bg-primary-releaf)] transition">{t("blog")}</Typography>
        <Typography variant="h6" className=" cursor-pointer font-[400] text-[1.2em] hover:text-[var(--bg-primary-releaf)] transition">{t("contact")}</Typography>
        <Typography variant="h6" className=" cursor-pointer font-[400] text-[1.2em] hover:text-[var(--bg-primary-releaf)] transition">{t("about")}</Typography>
      </div>
