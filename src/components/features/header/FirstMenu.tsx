      ...
      <div className="flex flex-row items-center gap-8">
        ...
        <picture className="relative" onClick={() => navigateTo("/cart")}>
          <i className=" cursor-pointer flex flex-row items-center">
            ...
            >
              <path
                d="M10 20L20.9 19.0912C24.3112 18.8075 25.0763 18.0625 25.4538 14.6613L26.25 7.5M7.5 7.5H27.5"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M7.5 27.5C8.88071 27.5 10 26.3807 10 25C10 23.6193 8.88071 22.5 7.5 22.5C6.11929 22.5 5 23.6193 5 25C5 26.3807 6.11929 27.5 7.5 27.5Z"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M21.25 27.5C22.6307 27.5 23.75 26.3807 23.75 25C23.75 23.6193 22.6307 22.5 21.25 22.5C19.8693 22.5 18.75 23.6193 18.75 25C18.75 26.3807 19.8693 27.5 21.25 27.5Z"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M10 25H18.75M2.5 2.5H3.7075C4.88875 2.5 5.9175 3.28125 6.20375 4.39375L9.925 18.845C10.0173 19.2064 10.0259 19.5841 9.95008 19.9494C9.87426 20.3146 9.71605 20.6577 9.4875 20.9525L8.28875 22.5"
                stroke="black"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
