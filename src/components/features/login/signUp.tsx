...
const SignUp = () => {
    ...
    const togglePasswordSignUpVisibility = () => setShowPasswordSignUp(prev => !prev);
    ...
    return (
        <div className="w-full p-6 px-0 ps-15">
            <div className="flex flex-col gap-8">
                ...
                <form className="flex flex-col items-start gap-7 w-full ">
                    ...
                    <div className="flex flex-col items-start gap-5 w-full">
                        <Label htmlFor="passwordSignUp" className="flex flex-col items-start gap-5 w-full">
                            <Typography
                                variant="p"
                                className="font-medium w-max"
                            >
