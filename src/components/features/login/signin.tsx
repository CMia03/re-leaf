...
import { SIGN_IN } from "@/graphql/queries/authServices";
...
const SignIn = () => {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (jwt) {
        ...
        toast.error("Connexion échouée : Jeton manquant.");
      }
    } catch (error) {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      router.push("/dashboard"); // ou "/dashboard" selon ta logique
    }
  }, [isAuthenticated]);
    ...
    <div className="w-full p-6 px-0">
      <div className="flex flex-col gap-8">
        ...
        <form
          ...
          className="flex flex-col items-start gap-7 w-full border-r-1 border-r-solid border-r-[#0000001A] pe-15"
        >
          <Label className="flex flex-col items-start gap-5 w-full">
            <Typography variant="p" className="font-medium w-max">
              {t("emailSignIn")} *
            </Typography>
            <Input
              type="email|text"
          ...
          <div className="flex flex-col items-start gap-5 w-full">
            <Label
              ...
              className="flex flex-col items-start gap-5 w-max bg-red"
            >
              <Typography variant="p" className="font-medium w-max">
                {t("password")} *
              </Typography>
            ...
            <div className="w-full relative">
              ...
              <i
                ...
                className="absolute top-1/2 right-0 translate-y-[-50%] mr-4"
              >
                {showPassword ? (
                  ...
                  >
                    ...
                    />
                    <path
                      d="M18 18C16.2051 19.2945 14.1448 20 12 20C7 20 2.73 15.636 2 12C2.36325 10.2089 3.39071 8.55274 4.87494 7.28287"
                      stroke="black"
                      strokeOpacity="0.5"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                    ...
                    />
                    <path
                      d="M9.87868 4.87868C10.5711 4.62733 11.2818 4.5 12 4.5C16.5 4.5 20.27 8.136 21 12C20.7111 13.4204 19.9876 14.7698 18.9459 15.8942"
                      stroke="black"
                      strokeOpacity="0.5"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                  ...
                  >
                    <path
                      d="M0.666992 4.66667C0.666992 4.66667 4.39783 0.5 9.00033 0.5C13.6028 0.5 17.3337 4.66667 17.3337 4.66667"
                      stroke="black"
                      strokeOpacity="0.5"
                      strokeWidth="0.9375"
                      strokeLinecap="round"
          ...
          <div className="flex flex-row justify-between w-full">
            <div className="flex items-center space-x-2">
              <Checkbox
                id="terms"
                className="rounded-full border-1 border-[#0000004D] w-5 h-5 scale-[0.85]"
              />
              <Label
                htmlFor="terms"
            ...
            <div className="w-full">
              <Typography
                variant="p"
                className="font-medium hover:underline hover:underline-offset-4 transition  float-end cursor-pointer"
          ...
          >
            <Typography variant="D1">{t("logIn")}</Typography>
          </Button>
        </form>
      </div>
    </div>
