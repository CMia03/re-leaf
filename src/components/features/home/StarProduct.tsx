    ...
    return (
        <div className="w-full max-w-7xl mx-auto flex flex-col gap-5 sm:gap-12 lg:gap-[3.5em] pt-8 sm:pt-12 lg:pt-[50px] px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center mx-auto my-0 w-max gap-2">
                <Typography variant="h2" className="border-none text-center text-xl sm:text-2xl lg:text-3xl xl:text-4xl">{t('startProduct').toUpperCase()}</Typography>
                <Typography variant="p" className="border-none text-center text-sm sm:text-base lg:text-lg max-w-2xl">{t('startProductDescription')}</Typography>
            </div>
